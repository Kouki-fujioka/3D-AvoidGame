...
namespace Unity.Game.Behaviours
{
    ...
    public class Bullet : MonoBehaviour
    {
        ...
        //[SerializeField, Tooltip("")] GameObject m_Particle;
        ...
        void Awake()
        {
            ...
            //ParticleSystem m_ParticleSystem = m_Particle.GetComponent<ParticleSystem>();
        ...
        void Update()
        {
            ...
            if (!m_Launched)
            {
                ...
                {
                    //if (collider != m_Collider && !collider.GetComponent<PlayerController>() && !collider.GetComponent<LEGOBehaviourCollider>())
                    if (collider != m_Collider && !collider.GetComponent<PlayerController>())
                    {
                        collisions = true;
                        break;
                    }
